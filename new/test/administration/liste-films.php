...
<body>
	...
	<nav class="links" style="--items: 5;">
		...
		<a href="#">Je sais pas</a>
		<a href="#">Je sais pas</a>
		<a href="../liste-films.php">Mode publique</a>
		<span class="line"></span>
	</nav>
</header>
<br><br><br>
		<header><h2>Liste des Transformers</h2></header>
		<a href="ajouter-tf.html">Ajouter un Transformers </a>
		...
		<a href="film.php?id=<?=$transformer['id']?>">
			...
			<img class="illustration" src="../illustration/<?=$transformer['illustration']?>" alt=""/>
				...
				<a href="modifier_TF.php?id=<?=$transformer['id']?>">modifier</a>
				<a href="supprimer_TF.php?id=<?=$transformer['id']?>">Supprimer</a>
			</div>
		</a>
		<?php	
		}
